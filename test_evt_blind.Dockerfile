...
CMD python src/testing.py -t evt-blind -n 1000 -m 500 -a perfect_${TESTING_ENV} -s test_${TESTING_ENV}_evt-blind --n_strategies 5 --traces-from test_${TESTING_ENV}_baseline